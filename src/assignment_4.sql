-- Using the DataBase which we created Before

USE 
Company
GO

-- Crearing the Table email_signup 

CREATE TABLE email_signup (id int, email_id VARCHAR(50), signup_date date);

-- Inserting The Values in email_signup Table
...
-- Query to replace NULL Values with '1970-01-01'
